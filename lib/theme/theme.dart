...
ThemeData getTheme() {
  return ThemeData(
    ...
    textTheme: const TextTheme(
      headline1: TextStyle(color: colourHeadline, fontSize: 24),
      headline2: TextStyle(color: colourHeadline, fontSize: 23),
      headline3: TextStyle(color: colourHeadline, fontSize: 22),
      headline4: TextStyle(color: colourHeadline, fontSize: 21),
      headline5: TextStyle(color: colourHeadline, fontSize: 20),
      headline6: TextStyle(color: colourHeadline, fontSize: 19),
