...
class Combat extends StatelessWidget {
  final CombatTagModel tag;
  final double bottomPadding;
  final trans = t.numbered; // get translation

  Combat(this.tag, {Key? key, this.bottomPadding = paddingLarge})
      : super(key: key);
          ...
          children: [
            WidgetSpan(
              child: Padding(
                  ...
                  child: Text('${tag.enemy}:')),
            ),
            WidgetSpan(
              child: Padding(
                  padding: const EdgeInsets.only(right: paddingNormal),
                  child: Text(trans.combatSkill)),
            ),
            WidgetSpan(
              child: Padding(
                  padding: const EdgeInsets.only(right: paddingLarge),
                  child: Text(tag.combatskill.toString())),
            ),
            WidgetSpan(
              child: Padding(
                  padding: const EdgeInsets.only(right: paddingNormal),
                  child: Text(trans.endurance)),
            ),
