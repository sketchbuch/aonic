import 'package:aonic/models/book/meta/description_model.dart' as model;
...
void main() {
  group('Model - DescriptionModel()', () {
    final tag =
        model.DescriptionModel.fromXml(getRootXmlElement(descriptionXml));
