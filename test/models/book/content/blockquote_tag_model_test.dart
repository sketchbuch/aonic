import 'package:aonic/models/book/content/blockquote_model.dart';
...
void main() {
  group('Model - BlockquoteTagModel()', () {
    ...
    void testListType(String type, String xml, Object json) {
      group(type, () {
        final tag = BlockquoteTagModel.fromXml(getRootXmlElement(xml));
