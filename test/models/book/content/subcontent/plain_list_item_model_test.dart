...
import 'package:aonic/models/book/content/subcontent/plain_list_item_model.dart';
import 'package:aonic/models/book/content/subcontent/toc_item_model.dart';
import 'package:test/test.dart';

import '../../../../helpers.dart';

const plainListItemXml =
...
const plainListSectionXml =
    '''<section class="$plainListSectionType" id="$plainListSectionId">
...
void main() {
  group('Model - PlainListItemModel.fromXml()', () {
    final tag =
        PlainListItemModel.fromXml(getRootXmlElement(plainListItemXml), 1);
    ...
    group('Subcontent - Single node (!isRenderableNode)', () {
      ...
      final tag = PlainListItemModel.fromXml(getRootXmlElement(xml), 1);
      final expectedJson = {
        "content": [
          {
            "texts": [
  ...
  group('Model - PlainListItemModel.fromTocItem()', () {
    final section =
        SectionTagModel.fromXml(getRootXmlElement(plainListSectionXml));
    final tocSection = TocItemModel(section, 1);
    final tag = PlainListItemModel.fromTocItem(tocSection);
