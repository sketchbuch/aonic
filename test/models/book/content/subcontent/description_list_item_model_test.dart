import 'package:aonic/models/book/content/subcontent/description_list_item_model.dart';
...
void main() {
  group('Model - DescriptionListItemModel()', () {
    ...
    void testDescriptionListItemType(String type, String xml, Object json) {
      group('$type', () {
        final tag = DescriptionListItemModel.fromXml(getRootXmlElement(xml));
