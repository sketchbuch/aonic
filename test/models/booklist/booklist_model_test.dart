import 'package:aonic/models/booklist/booklist_model.dart';
      ...
      'books': [
        {
          ...
          'title': bookOneTitle,
          'xmlPath':
              'https://www.projectaon.org/data/trunk/$language/xml/$bookOneCode.xml'
        },
        {
          'code': bookTwoCode,
          'isSupported': false,
          ...
          'title': bookTwoTitle,
          'xmlPath':
              'https://www.projectaon.org/data/trunk/$language/xml/$bookTwoCode.xml'
        },
      ]
    };

    test('Returns expected JSON', () {
      final list = BooklistModel(bookData, supportedBooks, language);
